...
namespace System.Windows.Controls.WpfPropertyGrid
{
	...
	public abstract class GridEntryContainer : ContentControl
	{
		...
		public static readonly DependencyProperty ParentContainerProperty =
			DependencyProperty.RegisterAttached("ParentContainer", typeof(GridEntryContainer), typeof(GridEntryContainer), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits));
		...
		/// </summary>
		public static readonly DependencyProperty EntryProperty = DependencyProperty.Register("Entry", typeof(GridEntry), typeof(GridEntryContainer), new FrameworkPropertyMetadata(null));
