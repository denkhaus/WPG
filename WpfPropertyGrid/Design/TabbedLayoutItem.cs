...
namespace System.Windows.Controls.WpfPropertyGrid.Design
{
	...
	public class TabbedLayoutItem : TabItem
	{
		...
		/// </summary>
		public static readonly DependencyProperty CanCloseProperty = DependencyProperty.Register("CanClose", typeof(bool), typeof(TabbedLayoutItem), new PropertyMetadata(false));
