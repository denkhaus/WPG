...
namespace System.Windows.Controls.WpfPropertyGrid.Design
{
	...
	public class ExtendedPropertyEditorTab : TabbedLayoutItem
	{
		...
		public ExtendedPropertyEditorTab(PropertyItem property) : this()
		{
		...
		private DataTemplate GetDataTemplate(object template)
		{
			...
			DataTemplate dataTemplate = template as DataTemplate;
			if (dataTemplate != null) return dataTemplate;

			ComponentResourceKey resourceKey = template as ComponentResourceKey;
			if (resourceKey == null) return null;

			return resourceLocator.GetResource(resourceKey) as DataTemplate;
		}
	}
}
