...
namespace System.Windows.Controls.WpfPropertyGrid
{
	...
	public class PropertyItemComparer : IComparer<PropertyItem>
	{
		...
		public virtual int Compare(PropertyItem x, PropertyItem y)
		{
			...
			DisplayAttribute attribute = x.GetAttribute<DisplayAttribute>();
			if (attribute != null)
			{
				try 
				{ 
					int? attemptOrder = attribute.GetOrder(); 
					if (attemptOrder != null)
						leftOrder = attemptOrder.Value; 
				}
				catch { }
			}
