...
namespace System.Windows.Controls.WpfPropertyGrid
{
	...
	public sealed class NamedBrushList : ObservableCollection<NamedBrush>
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="NamedBrushList"/> class.
		/// </summary>
		public NamedBrushList()
		{
			...
			foreach (PropertyInfo pi in typeof(Colors).GetProperties())
			{
				...
				NamedBrush nc = new NamedBrush(pi.Name, (Color)pi.GetValue(null, null));
				Add(nc);
			}
