...
namespace System.Windows.Controls.WpfPropertyGrid
{
	...
	{
		private readonly Dictionary<string, T> itemsMap = new Dictionary<string, T>();
		...
		{
			get { return string.IsNullOrEmpty(name) ? null : (itemsMap.ContainsKey(name) ? itemsMap[name] : null); }
		}
