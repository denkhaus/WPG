...
namespace System.Windows.Controls.WpfPropertyGrid.Controls
{
	...
	public class DoubleEditor : Control
	{
		...
		{
			DoubleEditor doubleEditor = (DoubleEditor)d;
		...
		/// </summary>
		/// <param name="e">The System.Windows.Input.MouseButtonEventArgs that contains the event data. This event data reports details about the mouse button that was pressed and the handled state.</param>
		...
		protected override void OnMouseMove(MouseEventArgs e)
		{
			...
			Vector vector = position - dragStartPoint;
			...
			if (isMouseDown)
			{
				...
				{
					Vector offset = position - lastDragPoint;
		...
		private void CalculateValue(double chageValue)
		{
			...
			changeOffset += chageValue;
			double newValue = changeValue + changeOffset;
			//
